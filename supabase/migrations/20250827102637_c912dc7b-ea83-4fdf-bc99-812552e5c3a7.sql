-- Primeiro, vamos criar os tipos ENUM para os diferentes tipos de usuário
...
-- Tipos de subscription para diferentes funcionalidades
...
-- Tipo de usuário para categorização geral  
...
-- Adicionar campos na tabela profiles para o sistema de roles
