-- Adjust functions: drop and recreate with new return signatures
...
-- Update rating functions as planned (repeat to ensure present)
...
BEGIN
  ...
  WHERE business_id = business_uuid; -- ALL reviews
END;
$$;
...
-- Recreate get_random_businesses with average_rating
...
-- Recreate get_featured_businesses with average_rating
...
-- Recreate get_public_businesses with ALL reviews metrics
