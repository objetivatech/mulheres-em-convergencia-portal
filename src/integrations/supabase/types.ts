...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      academy_courses: {
        Row: {
          ...
          is_standalone_lesson: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "academy_courses_material_type_id_fkey"
          ...
          {
            foreignKeyName: "academy_courses_subject_id_fkey"
            columns: ["subject_id"]
            isOneToOne: false
            referencedRelation: "academy_categories"
            referencedColumns: ["id"]
      ...
      business_menu_items: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "business_menu_categories"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      conecta_helpdesk_replies: {
        ...
        Relationships: [
          {
            foreignKeyName: "conecta_helpdesk_replies_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "conecta_helpdesk_posts"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      enroll_as_free_student: { Args: { _user_id: string }; Returns: undefined }
      ...
      has_academy_access: { Args: { _user_id: string }; Returns: string }
      has_role: {
        Args: {
