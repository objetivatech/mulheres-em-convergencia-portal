...
| 3 | **Empreendedoras Destaque** | `src/components/home/BusinessShowcase.tsx` | Existente |
| 4 | **Nossos Negócios** | `src/components/home/BusinessShowcase.tsx` | Existente |
| 5 | **Eventos e LPs** | `src/components/home/EventsAndLPsSlider.tsx` | Existente - slider dinâmico |
| 6 | **MeC Academy** | `src/components/home/AcademyShowcase.tsx` | Novo - cursos em destaque + CTA R$ 29,90/mês |
| 7 | **Planos** | `src/components/home/PlansPreview.tsx` | Novo - cards dos 3 planos com preços |
...
| 11 | **Embaixadoras** | `src/components/home/AmbassadorsShowcase.tsx` | Novo - carrossel com embaixadoras |
| 12 | **CTA Final** | `src/components/home/FinalCTA.tsx` | Novo - bloco de fechamento |
...
- **Embaixadoras** (`usePublicAmbassadors`): embaixadoras com `show_on_public_page = true`
