-- 0007 — Ajustes de segurança nos resumos (views)
-- As views de resumo eram legíveis por qualquer usuária autenticada.
-- Agora cada uma filtra internamente: administradora vê tudo, associada vê o seu.
